            ...
            if(!price.isEmpty()){
                if(price.equals("sorted_by_ascending_price")) {
                    if (!contract.isEmpty()){
                        ...
                        } else if (contract.equals("closes")) {
                        ...
                        } else if (contract.equals("electronics")) {
                        ...
                        } else if (contract.equals("tourism")) {
                    ...
                    if (!contract.isEmpty()){
                        ...
                        if (contract.equals("furniture")) {
                            ...
                            model.addAttribute("search_product", productRepository.findByTitleAndCategoryOrderByPriceDesc(search.toLowerCase(), Float.parseFloat(ot), Float.parseFloat(Do), 10));
                        }

                    } else {model.addAttribute("search_product", productRepository.findByTitleOrderByPriceDesc(search.toLowerCase(), Float.parseFloat(ot), Float.parseFloat(Do)));}
                }
            } else {
